...
groups= (m.floor(total_students / students_per_group))
...
sweets_for_each= round(sweets_count /children_there)
remaining_sweets=(sweets_count % children_there)
if sweets_count== 0:
    print("\nInflation hitting hard, I see.")
else:print("Give",sweets_for_each,"sweets to each pupil."),\
